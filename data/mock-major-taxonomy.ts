...
export const mockMajorTaxonomy: MajorTaxonomyNode[] = [
  ...
  },
  {
    ...
    subjectSignals: ["economics", "history", "politics", "psychology"],
    dislikedSignals: ["physics"],
    domainSignals: ["social-sciences", "law", "business"],
    problemSignals: ["policy", "community", "systems", "public impact"],
    careerSignals: ["policy", "government", "ngo", "strategy"],
    annualTuitionBandUsd: [18000, 44000],
    personalitySignals: {
      analytical: 4,
      creative: 2,
      teamwork: 4,
  ...
  },
  {
    ...
    subjectSignals: ["psychology", "biology", "statistics", "literature"],
    dislikedSignals: ["accounting"],
    domainSignals: ["health", "social-sciences", "creativity"],
    problemSignals: ["behavior", "research", "wellbeing", "human systems"],
    careerSignals: ["counseling", "human resources", "behavior", "ngo"],
    annualTuitionBandUsd: [19000, 46000],
    personalitySignals: {
      analytical: 3,
      creative: 3,
      teamwork: 4,
